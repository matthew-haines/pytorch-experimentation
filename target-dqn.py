...
class DQN:
    ...
    def __init__(self, epsilon=1.0, epsilon_decay=0.995, epsilon_min=0.01, n_episodes=3000, gamma=0.99, batch_size=64, target_update=100):
    ...
    def replay(self):
        ...
        for state, action, reward, next_state, done in minibatch:
            ...
            y[action] = reward if done else reward + self.gamma * \
                torch.max(self.target_network.forward(next_state))
            y_batch.append(y)
